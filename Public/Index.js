...
let printRecipe = function() {
    ...
    for (i = 0; i < 13; i++) {
        ...
        if (stepCounter > 13) {
            ...
            jerkyObject.Items.forEach(element => steptext += element[1] + ' ' + element[2] + ' ' + element[0] + ', ')
            ...
            steptext = `Contemplate how good your Jerky will taste when it is finished. Meanwhile, stir and fold the ${jerkyObject.Meat[0][0]} a few times throughout the marination process. As the alloted time comes to an end, prepare your ${jerkyObject.Appliance[0][0]}.`
